//
//  KHSensorsAnalyticsKeychainTool.m
//  KHAnalyticsSDK
//
...
@interface KHSensorsAnalyticsKeychainTool ()
...
@implementation KHSensorsAnalyticsKeychainTool
...
- (nullable NSString *)value {
    NSMutableDictionary *query = [KHSensorsAnalyticsKeychainTool keychainQueryWithService:self.service accessGroup:self.accessGroup key:self.key];
